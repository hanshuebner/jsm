...
MIDI.MIDIOutput.prototype.nrpn7 = function (parameter, value) {
...
MIDI.MIDIOutput.prototype.nrpn14 = function (parameter, value) {
...
function generateEvents(midiInput, messages, error)
{
    ...
    for (var i in messages) {
        ...
        case 0xD0:
            ...
            break;
        case 0xE0:
            value = 0x2000 - ((message[2] << 7) | message[1]);
            midiInput.emit('pitchWheelChange',  value, channel);
            break;
        case 0xF0:
...
function processNrpn(controllerNumber, value, channel) {
    ...
    case 0x06:
        nrpn.valueMsb = value;
        if (!nrpn.is14Bit) {
            this.emit('nrpn7', nrpn.parameter(), nrpn.value(), channel);
        }
        break;
    case 0x26:
        nrpn.valueLsb = value;
        ...
        if (nrpn.is14Bit) {
            this.emit('nrpn14', nrpn.parameter(), nrpn.value(), channel);
        }
        break;
    case 0x60:
...
MIDI.MIDIInput.prototype.channels = function(argument)
{
    ...
    console.log('channel mask', this.channelMask);
